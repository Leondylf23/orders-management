      ...
      {isForgotPassPage ? (
        <div className={classes.innerContainer}>
          ...
          <form className={classes.formContainer} onSubmit={sendForgotPasswordData}>
            ...
            <div className={classes.forgotPassFooter} onClick={() => setIsForgotPassPage(false)}>
        ...
        <div className={classes.innerContainer}>
          ...
          <form className={classes.formContainer} onSubmit={sendLogin}>
            ...
            <div className={classes.forgotPasswordContainer}>
              <div className={classes.text} onClick={() => setIsForgotPassPage(true)}>
            ...
            <h3 className={classes.footer}>
              ...
              <div onClick={() => navigate('/register')} className={classes.footerLink}>
